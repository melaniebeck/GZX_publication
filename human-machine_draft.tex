...
with a way of quickly generating large subject samples with accurate
labels provided by human classifications. These retired subjects are the basis of the 
machine's training sample which is dynamically generated as a function
of project time according to figure~\ref{fig: fiducial run}. For the following
analysis we again build off of our fiducial model where, within 10 days,
SWAP has accumulated ~20K 
